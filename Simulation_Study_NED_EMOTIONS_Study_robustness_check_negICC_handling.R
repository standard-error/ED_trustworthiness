...
# Save Results ------------------------------------------------------------
save(setzero, file="results/02_revision_1/EMOTIONS study/NED/robustness check negICC handling/sim_results_NED_set_neg_ICC_zero_EMOTIONS_Study.rda")
...
# Save Results ------------------------------------------------------------
save(excl, file="results/02_revision_1/EMOTIONS study/NED/robustness check negICC handling/sim_results_NED_exclude_neg_ICC_EMOTIONS_Study.rda")
