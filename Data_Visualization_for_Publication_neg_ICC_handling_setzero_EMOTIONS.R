...
load("results/02_revision_1/EMOTIONS study/NED/neg ICC handling/setzero/processed/aggregated_results_NED_EMOTIONS_set_zero.rda")
agg_ned <- agg
rm(agg)

load("results/02_revision_1/EMOTIONS study/PED/neg ICC handling/setzero/processed/aggregated_results_PED_EMOTIONS_set_zero.rda")
agg_ped <- agg
rm(agg)
...
ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_combined.pdf",plot = combined, device="pdf", height = 222, width = 222, unit="mm")

ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_combined.svg",plot = combined, device="svg", height = 222, width = 222, unit="mm")

# as tiff
tiff("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_combined.tiff", units="mm", width=222, height=222, res=1200)
combined
dev.off()
...
ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_Z-transformed_combined.pdf",plot = combined, device="pdf", height = 222, width = 222, unit="mm")

ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_Z-transformed_combined.svg",plot = combined, device="svg", height = 222, width = 222, unit="mm")

# as tiff
tiff("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_random_draws_NED_PED_Z-transformed_combined.tiff", units="mm", width=222, height=222, res=1200)
combined
dev.off()
...
ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_combined.pdf",plot = combined, device="pdf", height = 222, width = 222, unit="mm")

ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_combined.svg",plot = combined, device="svg", height = 222, width = 222, unit="mm")

# as tiff
tiff("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_combined.tiff", units="mm", width=222, height=222, res=1200)
combined
dev.off()
...
ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_Z-transformed_combined.pdf",plot = combined, device="pdf", height = 222, width = 222, unit="mm")

ggsave("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_Z-transformed_combined.svg",plot = combined, device="svg", height = 222, width = 222, unit="mm")

# as tiff
tiff("plots/02_revision_1/for publication/neg ICC handling/EMOTIONS_plots_setzero_ordered_draws_NED_PED_Z-transformed_combined.tiff", units="mm", width=222, height=222, res=1200)
combined
dev.off()
