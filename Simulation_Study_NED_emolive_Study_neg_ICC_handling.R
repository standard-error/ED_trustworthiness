...
# '' Save Results ---------------------------------------------------------
save(setzero, file="results/02_revision_1/emolive study/NED/neg ICC handling/setzero/raw/sim_results_NED_set_neg_ICC_zero_emolive_Study.rda")
...
# save results
save(excl, file="results/02_revision_1/emolive study/NED/neg ICC handling/exclude/raw/sim_results_NED_exclude_neg_ICC_emolive_Study.rda")
