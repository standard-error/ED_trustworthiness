...
combined45 <- ggpubr::annotate_figure(combined45,
...
combined810 <- ggpubr::annotate_figure(combined810,
                              bottom = ggpubr::text_grob("Number of Measurement Occasions", size = 12))
...
#  [5] gridExtra_2.3      R6_2.6.1           ggpubr_0.6.3       generics_0.1.4    
#  [9] Formula_1.2-5      backports_1.5.1    car_3.1-5          tzdb_0.5.0        
# [13] pillar_1.11.1      RColorBrewer_1.1-3 rlang_1.2.0        stringi_1.8.7     
# [17] broom_1.0.12       S7_0.2.0           timechange_0.3.0   cli_3.6.5         
# [21] withr_3.0.2        magrittr_2.0.3     grid_4.5.3         rstudioapi_0.18.0 
# [25] hms_1.1.4          cowplot_1.2.0      lifecycle_1.0.5    vctrs_0.6.5       
# [29] rstatix_0.7.3      glue_1.8.0         farver_2.1.2       abind_1.4-8       
# [33] carData_3.0-6      tools_4.5.3        pkgconfig_2.0.3  
